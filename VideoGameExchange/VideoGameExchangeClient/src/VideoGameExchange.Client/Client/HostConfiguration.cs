...
{
    /// <summary>
    /// Provides hosting configuration for VideoGameExchange.Client
    /// </summary>
    public class HostConfiguration
    {
        ...
        public HostConfiguration(IServiceCollection services)
        {
            ...
            _jsonOptions.Converters.Add(new GameInputJsonConverter());
            _jsonOptions.Converters.Add(new PatchGameJsonConverter());
