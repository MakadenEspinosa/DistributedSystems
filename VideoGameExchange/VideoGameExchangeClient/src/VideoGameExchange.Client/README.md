...
additionalProperties:
  packageGuid: '{356A7443-0D07-4ABC-B877-F410B88A0BC5}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            IAddGameApiResponse apiResponse = await api.AddGameAsync("todo");
            Game? model = apiResponse.Ok();
        }
...
## Api Information
- appName: Video Game Exchange API
- appVersion: 1.0.0
- appDescription: A basic API that lets users exchange video games.
